...
const files=['index.html','styles.css','engine.js','game.js','favicon.svg','assets/emberdeep.png'];
for(const file of ['engine.js','game.js'])new vm.Script(fs.readFileSync(path.join(__dirname,file),'utf8'),{filename:file});
