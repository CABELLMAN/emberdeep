...
const files=['index.html','styles.css','campaign.js','engine.js','town-ui.js','game.js','favicon.svg','assets/emberdeep.png'];
for(const file of ['campaign.js','engine.js','town-ui.js','game.js'])new vm.Script(fs.readFileSync(path.join(__dirname,file),'utf8'),{filename:file});
